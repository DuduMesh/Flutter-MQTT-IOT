...
class _conteudoPagina1State extends State<conteudoPagina1> {
  ...
  Future<int> conectaMQTT() async {
    ...
    final connMess = MqttConnectMessage()
        ...
        .withWillTopic(
            'FIT_Eduardo') // If you set this you must set a will message
    ...
    const topic1 = 'FIT_EDUARDO_PRESTES'; // Not a wildcard topic
    client.subscribe(topic1, MqttQos.atLeastOnce);
    print('EXAMPLE:: <<<< SUBSCRIBE 2 >>>>');
    const topic2 = 'FIT_EDUARDO_PRESTES'; // Not a wildcard topic
    client.subscribe(topic2, MqttQos.atLeastOnce);
    const topic3 =
        'FIT_EDUARDO_PRESTES'; // Not a wildcard topic - no subscription
